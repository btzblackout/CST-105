...
public class NFLPlayer
{
     ...
     */
    //Declare variables
    String name, birthPlace, college, experience, highSchool, team, height, position, type;
    double weight;
    int age, number;
    ...
    public NFLPlayer(String name, String position, String birthPlace, String college, String experience, String highSchool, String team,
                     String height, double weight, int age, int number, boolean available, String type)
    {
        this.name = name;
    ...
    //main method "driver" to JavaFXTest.test
    public static void main(String[] args)
    {
        ...
        NFLPlayer player2 = new NFLPlayer("Raymond Lawson", "QB", "Frankfort, KY", "GCU", "2nd Year", "Greeneville High School", "My Team", "6ft 4in", 215, 23, 1, true, "Offensive");
